...
# ═══════════════════════════════════════════════════════════════════════
    ...
    with col1:
        ...
        fig_var.update_layout(**PLOT_LAYOUT, height=300, barmode='group',
            yaxis_ticksuffix='%', yaxis_title='Daily VaR (%)')
    ...
    with col2:
        ...
        fig_vol.update_layout(**PLOT_LAYOUT, height=300,
            yaxis_ticksuffix='%', yaxis_title='Implied Vol (%)')
...
# ═══════════════════════════════════════════════════════════════════════
    ...
    with tab1:
        ...
        fig_earn.update_layout(**PLOT_LAYOUT, height=260,
            yaxis_ticksuffix='%', yaxis_zeroline=True,
            yaxis_zerolinecolor='rgba(255,255,255,0.15)')
